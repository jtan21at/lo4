 ...
 */
     ...
     */
    public static long powerN (int x, int n,long total) {
        if (n == 0)
            return total;
        else
            return   powerN(x, n - 1,x*total);
    }
    /**
     *  Q2: recursive method that computes the following series
     *      S = 1 + 1/2 + 1/3 + ...+1/ n
     */
    public static double harmonicSum(int n, double sum) {
        if (n == 1)
            return 1+sum;
        else
            return harmonicSum(n - 1,1.0/n +sum );
    }
    /**
    ...
    public static boolean contains(char c, String s){
        if (s == null || s.isEmpty())
            ...
            return contains(c, s.substring(1));
    }
    /**
     * Q5: recursive method that returns the number of occurences of char c in
     *     String s.
     */
    public static int numOccurences(char c, String s,int feq) {
        if (s == null || s.isEmpty())
            return feq;
        else
            return   numOccurences(c,
                    s.substring(1),(s.charAt(0) == c? 1 : 0) +feq);
    }
...
/////////////////////// TESTS FOR
       // Q1 ///////////////////////////////////
        ...
        System.out.println("powerN(2, 0) is " + powerN(2,0,1));
        System.out.println("powerN(2, 1) is " + powerN(2,1,1));
        System.out.println("powerN(-2, 3) is " + powerN(-2,3,1));
        System.out.println("powerN(-2, 4) is " + powerN(-2,4,1));
        System.out.println("powerN(2, 5) is " + powerN(2,5,1));
        System.out.println();
/////////////////////// TESTS FOR
       // Q2  //////////////////////////////////
        System.out.println("---------- Q2 HARMONIC SERIES ------------------");
        System.out.println("harmonicSum(1) is " + harmonicSum(1,0.0));
        System.out.println("harmonicSum(2) is " + harmonicSum(2,0.0));
        System.out.println("harmonicSum(5) is " + harmonicSum(5,0.0));
        System.out.println();
/////////////////////// TESTS FOR
       // Q3  //////////////////////////////////
...
/////////////////////// TESTS FOR
       // Q5  //////////////////////////////////
        ...
        System.out.println("numOccurences('a', \"ab\") is "
                + numOccurences('a', "ab",0));
        System.out.println("numOccurences('a', \"ba\") is "
                + numOccurences('a', "ba",0));
